...
public class DocumentoDTO {
    ...
    public DocumentoDTO(String id, String nomeEmpresa, String contactoEmpresa, 
                       String objetivoEstagio, LocalDateTime dataUpload) {
        this.id = id;
    ...
    public String getObjetivoEstagio() { return objetivoEstagio; }
    public void setObjetivoEstagio(String objetivoEstagio) { this.objetivoEstagio = objetivoEstagio; }

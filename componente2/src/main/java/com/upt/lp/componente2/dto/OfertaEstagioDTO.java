...
public class OfertaEstagioDTO {
    ...
    public OfertaEstagioDTO(String id, String titulo, String descricao, 
                           String empresaId, String empresaNome, TipoEstagio tipo) {
        this.id = id;
        this.titulo = titulo;
    ...
    public String getCoordenadorResponsavelId() { return coordenadorResponsavelId; }
    ...
    public LocalDate getDataLimiteInscricao() { return dataLimiteInscricao; }
    public void setDataLimiteInscricao(LocalDate dataLimiteInscricao) { this.dataLimiteInscricao = dataLimiteInscricao; }
    ...
    public int getNumeroCandidaturas() { return numeroCandidaturas; }
    public void setNumeroCandidaturas(int numeroCandidaturas) { this.numeroCandidaturas = numeroCandidaturas; }
}